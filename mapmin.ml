...
(* Derived from map.ml by Luca de Alfaro 
   This module also allows accessing the min and max elements of a map. *)
...
module Make(Ord: OrderedType) = struct
	...
	Empty -> raise Not_found
      | Node(Empty, v, d, r, _) -> (v, d)
      | Node(l, v, d, r, _) -> min_elt l 

    let rec max_elt = function 
	Empty -> raise Not_found
      | Node(l, v, d, Empty, _) -> (v, d)
      | Node(l, v, d, r, _) -> min_elt r
